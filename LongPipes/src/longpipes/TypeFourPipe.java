...
public class TypeFourPipe extends TypeThreePipe{
     ...
     * @param pipeInnerInsulation the boolean representing if this pipe has inner insulation
    ...
    /**
     * Get the double representing the percentage additional cost of having inner insulation in this pipe
